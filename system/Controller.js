...
// Example of listing buckets using async/await
...
// Example of listing buckets using promises
...
module.exports = class Controller {
    ...
    */
    ...
    async uploadFile(fileName, base64Data, type, oldFile = '') {
        return new Promise(async (resolve, reject) => {
          try {
            // Kiểm tra base64Data có phải là undefined hoặc null hay không
            if (!base64Data) {
              // Nếu có, báo lỗi và thoát khỏi hàm
              console.log("base64Data is undefined or null");
              reject("base64Data is undefined or null");
              return;
            }
            const _buf = Buffer.from(base64Data.replace(/^data:(.*?)\/\w+;base64,/, ''), 'base64');
            const _data = {
